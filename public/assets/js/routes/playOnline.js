...
const introOverlay = document.querySelector(".intro-page");
const tutorial = document.querySelector(".tutorial-overlay");
const exitTutorial = document.querySelector(".exit-tutorial");
